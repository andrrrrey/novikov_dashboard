...
DEFAULTS = {
    ...
    "info_business": (
        "Ваш текущий уровень развития бизнеса. Он определяется самым слабым из трёх "
        "направлений — маркетинг, продажи и управление: именно оно ограничивает рост. "
        "Чтобы поднять уровень, закрывайте материалы по отстающему направлению — "
        "прогресс-бар показывает, сколько материалов осталось пройти до следующего уровня."
    ),
}
